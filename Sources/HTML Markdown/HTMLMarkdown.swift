...
private struct BlockQuoteStyle {
    ...
    init(blockName: String) {
        ...
        case "Warning", "Correction":
            self.backgroundColor = HTMLColor(rawValue: "#FDF2F4").dark(.init(rawValue: "#2E0402"))
            self.borderColor = HTMLColor(rawValue: "#D02C1E").dark(.init(rawValue: "#EB4642"))
        case "Important":
            self.backgroundColor = HTMLColor(rawValue: "#FEFBF3").dark(.init(rawValue: "#291F04"))
            self.borderColor = HTMLColor(rawValue: "#966922").dark(.init(rawValue: "#F4B842"))
        case "Announcement", "Tip":
            self.backgroundColor = HTMLColor(rawValue: "#FBFFFF").dark(.init(rawValue: "#0F2C2B"))
            self.borderColor = HTMLColor(rawValue: "#4B767C").dark(.init(rawValue: "#9FFCE5"))
        case "Preamble":
            self.backgroundColor = HTMLColor(rawValue: "#FBF8FF").dark(.init(rawValue: "#1e1925"))
            self.borderColor = HTMLColor(rawValue: "#8D51F6").dark(.init(rawValue: "#8D51F6"))
        default:
            self.backgroundColor = HTMLColor(rawValue: "#f5f5f5").dark(.init(rawValue: "#323232"))
            self.borderColor = HTMLColor(rawValue: "#696969").dark(.init(rawValue: "#9a9a9a"))
        }
    }
}
