...
extension HTMLColor.Theme.Background {
    public static var swift: Self {
        .init(
            ...
            highlighted: .init(light: .hex("f05138").opacity(0.15), dark: .hex("ff6952").opacity(0.25)),
            ...
            errorMuted: .init(light: .hex("ffebe9").opacity(0.5), dark: .hex("3a1915").opacity(0.5)),
...
extension HTMLColor.Theme.Branding {
    public static var swift: Self {
        .init(
            ...
            primarySubtle: .init(light: .hex("f05138").opacity(0.15), dark: .hex("ff6952").opacity(0.2)),
