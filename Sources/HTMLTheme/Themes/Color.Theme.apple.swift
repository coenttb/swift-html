...
extension HTMLColor.Theme.Background {
    public static var apple: Self {
        .init(
            ...
            error: .init(light: .hex("ff3b30"), dark: .hex("ff453a")),
            errorMuted: .init(light: .hex("ffebe9").opacity(0.5), dark: .hex("3a0f0c").opacity(0.5)),
            success: .init(light: .hex("34c759"), dark: .hex("30d158")),
            successMuted: .init(light: .hex("e6f4ea").opacity(0.5), dark: .hex("0d2f1f").opacity(0.5)),
            warning: .init(light: .hex("ff9500"), dark: .hex("ff9f0a")),
            warningMuted: .init(light: .hex("fff4e5").opacity(0.5), dark: .hex("3a2003").opacity(0.5)),
