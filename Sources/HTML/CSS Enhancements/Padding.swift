...
extension HTML {
  ...
  private func paddingSides(
    ...
    self
      .if(padding.contains(where: { if case .top = $0 { return true } else { return false } })) {
        element in
        HTMLGroup {
      ...
      .if(padding.contains(where: { if case .bottom = $0 { return true } else { return false } })) {
        element in
        HTMLGroup {
          let lengthPercentage = padding.first(where: {
            if case .bottom = $0 { return true } else { return false }
      ...
      .if(padding.contains(where: { if case .left = $0 { return true } else { return false } })) {
        element in
        HTMLGroup {
          let lengthPercentage = padding.first(where: {
            if case .left = $0 { return true } else { return false }
      ...
      .if(padding.contains(where: { if case .right = $0 { return true } else { return false } })) {
        element in
        HTMLGroup {
          let lengthPercentage = padding.first(where: {
            if case .right = $0 { return true } else { return false }
