...
extension CSSPropertyAccessor {
    ...
    /// Sets the fill color using an HTMLColor value.
    @inlinable
    @discardableResult
    public func fill(
        _ color: HTMLColor?,
    ...
    /// Sets the fill color using a Color.WithDarkMode value.
    @usableFromInline
    @discardableResult
    @_disfavoredOverload
    func fill(
        ...
        case .global(let global):
            return CSSPropertyAccessor<HTML.AnyView>(
                base: HTML.AnyView(base.inlineStyle(CSS_Standard.Fill.self, global, media: media, selector: selector, pseudo: pseudo))
            )
    ...
    /// Sets the fill color using a global CSS value (inherit, initial, unset, revert).
    @inlinable
    @discardableResult
    public func fill(
