...
public struct Button<Content> {
    ...
    public init(
        ...
        formtarget: Target? = nil,
        attributes: [String: String] = [:],
        content: @escaping () -> Content
    ) {
        var attrs = attributes
        
        attrs["type"] = type.rawValue
        ...
        if let formenctype = formenctype {
            attrs["formenctype"] = formenctype.rawValue
        }
        
        if let formmethod = formmethod {
            attrs["formmethod"] = formmethod.rawValue
        }
        
        if let formnovalidate = formnovalidate, formnovalidate {
            attrs["formnovalidate"] = ""
        }
        
        if let formtarget {
            attrs["formtarget"] = formtarget.description
        }
...
/// Form encoding types for form submission
...
//
//"show-modal"
//This is a declarative equivalent of calling the .showModal() method on the dialog element.
//
//The button will show a <dialog> as modal. If the dialog is already modal, no action will be taken.
//
//"close"
//This is a declarative equivalent of calling the .close() method on the dialog element.
//
//The button will close a <dialog> element. If the dialog is already closed, no action will be taken.
//
//"request-close"
//This is a declarative equivalent of calling the .requestClose() method on the dialog element.
//
//The button will request to close a <dialog> element. If the dialog is already closed, no action will be taken.
//
//"show-popover"
//This is a declarative equivalent of calling the .showPopover() method on the popover element.
//
//This is equivalent to popovertargetaction with the value "show".
//
...
//
//"hide-popover"
//This is a declarative equivalent of calling the .hidePopover() method on the popover element.
//
//This is equivalent to popovertargetaction with the value "hide".
//
...
//
//"toggle-popover"
//This is a declarative equivalent of calling the .togglePopover() method on the popover element.
//
//This is equivalent to popovertargetaction with the value "toggle".
//
